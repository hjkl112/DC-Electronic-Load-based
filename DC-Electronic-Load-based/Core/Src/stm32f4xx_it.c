...
/* Private typedef -----------------------------------------------------------*/
/* USER CODE BEGIN TD */
unsigned long key_now_time=0;//按键长短按计时�??
uint8_t set_key=0,quit_key=0;
uint16_t capture_speed=0;//输入捕获�?
uint16_t capture_speed_time=0;//输入捕获计时�?
uint16_t temp_time=0;//温度更新时间
uint8_t data_display_time=0;//电压电流显示的刷新时�?
uint8_t ads1115_read_time=0;//读取ads1115的时�?
/* USER CODE END TD */
